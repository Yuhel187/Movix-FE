...
export default function MovieManagement() {
  ...
  const handleRetrainAI = async () => {
    setIsTraining(true);
    const toastId = toast.loading("Đang gửi yêu cầu huấn luyện AI...");

    try {
      await apiClient.post("/recommend/train");
      toast.success("Đã kích hoạt tiến trình huấn luyện thành công!", {
        id: toastId,
      });
    } catch (error) {
      console.error("Lỗi train AI:", error);
      toast.error("Không thể kích hoạt huấn luyện. Vui lòng thử lại.", {
        id: toastId,
      });
    } finally {
      setIsTraining(false);
        ...
        <div className="lg:w-8/12 space-y-4 order-2 lg:order-1">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-1">
            <h1 className="text-white text-xl font-semibold">
              {movieToEdit
                ? `Đang chỉnh sửa: ${movieToEdit.title}`
                : "Quản lý phim"}
            </h1>
            ...
            <Button
              ...
              disabled={isTraining}
              className="bg-purple-600 hover:bg-purple-700 text-white shadow-lg transition-all"
              size="sm"
            >
              {isTraining ? (
              ...
              {isTraining ? "Đang xử lý..." : "Cập nhật AI Suggestion"}
            </Button>
          </div>
                ...
                <Card className="bg-[#1F1F1F] border-2 border-dashed border-slate-700 h-96">
                  <CardContent className="h-full flex flex-col items-center justify-center text-center p-6">
                    ...
                    <p className="text-slate-400 max-w-xs">
                      Sử dụng thanh tìm kiếm ở cột bên phải để tìm và tải thông
                      tin một bộ phim vào form này.
                    </p>
                  </CardContent>
                </Card>
              )}
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateMovieField("title", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateMovieField("original_title", e.target.value)
                        }
                        className="mt-2 w-full px-3 py-2 bg-[#262626] border-slate-700 rounded text-white focus:border-primary"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <Popover>
                        ...
                        >
                          <Calendar
                            ...
                            onSelect={(date) =>
                              updateMovieField("release_date", date)
                            }
                            initialFocus
                            locale={vi}
                          />
                    ...
                    <div>
                      ...
                      <CountrySelect
                        ...
                        onValueChange={(val) =>
                          updateMovieField("country", { name: val })
                        }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateMovieField("poster_url", e.target.value)
                        }
                        className="mt-2 w-full px-3 py-2 bg-[#262626] border-slate-700 rounded text-white focus:border-primary"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateMovieField("backdrop_url", e.target.value)
                        }
                        className="mt-2 w-full px-3 py-2 bg-[#262626] border-slate-700 rounded text-white focus:border-primary"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateMovieField("trailer_url", e.target.value)
                      }
                      className="mt-2 w-full px-3 py-2 bg-[#262626] border-slate-700 rounded text-white focus:border-primary"
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateMovieField("description", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <GenreCombobox
                      allGenres={allGenres}
                      selectedGenres={
                        movieToEdit.movie_genres?.map((mg: any) => mg.genre) ||
                        []
                      }
                      onChange={(newSelection) =>
                        updateMovieField(
                          "movie_genres",
                          newSelection.map((g) => ({ genre: g }))
                        )
                      }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <MovieTypeSelect
                        value={
                          movieToEdit.media_type === "TV" ? "series" : "single"
                        }
                        onChange={(val) =>
                          updateMovieField(
                            "media_type",
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex items-center space-x-3 h-10 px-3 py-2 bg-[#262626] border border-slate-700 rounded-md">
                        <Switch
                          ...
                          onCheckedChange={(val) =>
                            updateMovieField("is_active", val)
                          }
                        ...
                        <>
                          ...
                          <h4 className="text-md font-semibold text-white">
                            ...
                            {currentSelectedSeason?.name ||
                              `Mùa ${currentSelectedSeason?.season_number}`}
                          </h4>
                          <div className="space-y-4 ">
                            {currentSelectedSeason?.episodes.map(
                                  ...
                                  {currentSelectedSeason &&
                                    currentSelectedSeason.episodes.length >
                                      ...
                                      <Button
                                        ...
                                        onClick={() =>
                                          handleRemoveEpisode(episode.id)
                                        }
                                      >
                  ...
                  {movieToEdit.media_type === "MOVIE" && (
                    <div className="space-y-4 pt-6 border-t border-slate-700">
                      <h3 className="text-lg font-semibold text-white">
                        QUẢN LÝ FILE PHIM LẺ
                      </h3>
                      <div>
                        <Label
                          htmlFor="single_file_url"
                          className="block text-sm font-medium text-gray-300 mb-1"
                        >
                          File phim (Tên file/URL)
                        </Label>
                        <Input
                          ...
                          value={
                            movieToEdit.seasons?.[0]?.episodes?.[0]
                              ?.video_url || ""
                          }
                          onChange={(e) => {
        ...
        <AlertDialogContent className="bg-[#1F1F1F] border-slate-700 text-white">
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              ...
              Huấn luyện lại hệ thống AI?
            </AlertDialogTitle>
            <AlertDialogDescription className="text-slate-400">
              Hệ thống khuyến nghị sẽ được tính toán lại dựa trên dữ liệu phim
              và tương tác người dùng mới nhất.
              <br />
              <br />
              Quá trình này có thể mất vài phút. Bạn có chắc chắn muốn tiếp tục?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
